...
|:---:|:---:|:--- |
| **BE, Robotics & Artificial Intelligence** | [Bangalore Institute of Technology](https://www.bit-bangalore.edu.in/), Bengaluru<br>2023 – 2027 | • Affiliated to [VTU](https://vtu.ac.in/) (Visvesvaraya Technological University)<br>• Approved by [AICTE](https://www.aicte-india.org/) & Accredited by [NBA](https://www.nbaind.org/) (Tier-I / Washington Accord Signatory)<br>• **Equivalency:** Equivalent to a 4-Year B.S. in Engineering (US/Canada) and B.Eng. Honours (UK/Europe/Australia)<br>• **Global Recognition:** Universally recognized under the Washington Accord for international PG studies (MS/PhD) and Professional Licensing (e.g., FE/PE in US)<br>• Specializing in Physical AI & Neural-Augmented Systems |
